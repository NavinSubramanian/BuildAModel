    ...
    <section id="pricing" className="pricing-section">
      <div className="container">
        ...
        <p className="section-subtitle">
          ...
          From one-time models to ongoing collaborations, we have plans that work for you.
        </p>
        ...
        <div className="pricing-cards">
          <div className="pricing-card">
            <div className="pricing-header">
              ...
              <p className="pricing-amount">Starting at <span>$149</span></p>
          ...
          <div className="pricing-card featured">
            ...
            <div className="pricing-header">
              <h3>Professional</h3>
              <p className="pricing-amount">Starting at <span>$299</span></p>
              <p className="pricing-description">
        ...
        <div className="pricing-note">
          <p>
            <strong>Note:</strong> All prices are starting points and may vary based on project complexity, 
            materials, size, and other specifications. Contact us for a personalized quote.
          </p>
        </div>
      </div>
    </section>
