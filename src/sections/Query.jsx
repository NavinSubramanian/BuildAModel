    ...
    <section id="quote" className="quote-section">
      <div className="container">
        ...
        <p className="section-subtitle">
          ...
          We'll get back to you within 24 hours with pricing and timeline information.
        </p>
        ...
        <div className="quote-form-container">
          {formState.submitted ? (
            <div className="success-message">
              <h3>Thank You!</h3>
              <p>Your quote request has been submitted. We'll contact you shortly with more information.</p>
              <button 
            ...
            <form className="quote-form" onSubmit={handleSubmit}>
              ...
              <div className="form-group full-width">
                ...
                {formState.errors.description && (
                  <p className="error-message">{formState.errors.description}</p>
                )}
              </div>
              ...
              <div className="form-group full-width">
                ...
                <input 
                  ...
                  multiple
                />
                <p className="file-help">Upload sketches, drawings, or reference images (Max 10MB)</p>
              </div>
